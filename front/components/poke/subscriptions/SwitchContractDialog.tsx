...
// Usage cap is denominated in AWU credits and stored verbatim on
// `credit_usage_configuration.usageCapCredits` — no fiat conversion.
// Keep this in sync with `MAX_USAGE_CAP_CREDITS` in
// `front/lib/api/poke/switch_contract.ts`.
const MAX_USAGE_CAP_CREDITS = 2_000_000;
